...
def main():
    ...
    if visualize:
        ...
        visualize_examples(args.benchmark_folder, args.comparison_folder, args.visualize_dir, caption=args.caption, n_examples=args.num_examples, files_folder=args.files_folder, is_cropped=args.cropped)
    else:
