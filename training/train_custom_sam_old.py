...
def main(data_folder, data_folder_validation, bbox_eps, visualization_active, batchsize, model_folder, out_images, num_epochs):
...
if __name__ == "__main__":
  ...
  parser.add_argument('--bbox-eps', default=20, type=int)
  parser.add_argument('--data-folder', default=None)
  parser.add_argument('--visualization-active', default=False, type=bool)
  parser.add_argument('--model-folder', default=None)
  parser.add_argument('--batchsize', default=1, type=int)
  parser.add_argument('--data-folder-validation', default=None)
  ...
  if vals["data_folder"] != None and vals["model_folder"] != None and vals["data_folder_validation"] != None and vals["out_images"] != None:
    ...
    main(data_folder, data_folder_validation, bbox_eps, visualization_active, batchsize, model_folder, out_images, num_epochs)
  else:
