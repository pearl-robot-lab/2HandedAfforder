...
cd scripts
python helper.py --rename_files_video ../../dataset/EPIC_DATA/frames/$1/$2 && \
cd ../XMem_Batch && \
...
cd ../scripts
python helper.py --dilate_masks_dir ../../dataset/EPIC_DATA/xmem_masks/$2/hand/both && \
python helper.py --recolor_masks_white ../../dataset/EPIC_DATA/xmem_masks/$2/hand/both && \
python helper.py --recolor_masks_white ../../dataset/EPIC_DATA/xmem_masks/$2/hand/left && \
python helper.py --recolor_masks_white ../../dataset/EPIC_DATA/xmem_masks/$2/hand/right && \
python helper.py --recolor_masks_white ../../dataset/EPIC_DATA/xmem_masks/$2/object/left && \
python helper.py --recolor_masks_white ../../dataset/EPIC_DATA/xmem_masks/$2/object/right && \
python helper.py --fill_zeros_files ../XMem_Batch/segmentations/$2/hand/both && \
python helper.py --restructure_folder_for_agent_inpaint_folder ../XMem_Batch/segmentations/$2/hand/both --restructure_folder_for_agent_inpaint_out ../../dataset/EPIC_DATA/xmem_masks_restructured/$2 && \
python helper.py --add_raw_to_dir_dir ../../dataset/EPIC_DATA/xmem_masks_restructured/$2 --add_raw_to_dir_raw ../../dataset/EPIC_DATA/frames/$1/$2 && \
python helper.py --recolor_whole_folder_structure ../../dataset/EPIC_DATA/xmem_masks_restructured/$2 && \
python helper.py --apply_padding_dir ../../dataset/EPIC_DATA/xmem_masks_restructured/$2 --apply_padding_out ../../dataset/EPIC_DATA/xmem_masks_padded/$2 && \
python helper.py --batchify_agent_inp_dirs ../../dataset/EPIC_DATA/xmem_masks_padded/$2 --batchify_agent_inp_out ../../dataset/EPIC_DATA/xmem_masks_batched/$2 --batchify_agent_inp_batchsize 2 && \

# Agent inpainting
cd ../agent_inpainting && \
python demo_script_batch.py ../../dataset/EPIC_DATA/xmem_masks_batched/$2 ../../dataset/EPIC_DATA/hand_inpainting/$2 && \
rm -r ../XMem_Batch/segmentations/$2 && \
rm -r ../../dataset/EPIC_DATA/xmem_masks_restructured/$2 && \
rm -r ../../dataset/EPIC_DATA/xmem_masks_padded/$2 && \
rm -r ../../dataset/EPIC_DATA/xmem_masks_batched/$2 && \
cd ../scripts && \

# Preprocess masks for object completion
#python helper.py --batchify_migan_dir ../../dataset/EPIC_DATA/xmem_masks/$2/hand/left --batchify_migan_batchsize 16 --batchify_migan_out ../../dataset/EPIC_DATA/xmem_masks_batched/$2/hand/left && \
#python helper.py --batchify_migan_dir ../../dataset/EPIC_DATA/xmem_masks/$2/hand/right --batchify_migan_batchsize 16 --batchify_migan_out ../../dataset/EPIC_DATA/xmem_masks_batched/$2/hand/right && \
...
# Process results
# cd ../scripts
# python helper.py --regenerate_mask_src ../../dataset/EPIC_DATA/mask_completion/$2/left && \
# python helper.py --regenerate_mask_src ../../dataset/EPIC_DATA/mask_completion/$2/right && \
# python helper.py --calculate_mask_difference_pre ../../dataset/EPIC_DATA/xmem_masks/$2/object/left/ --calculate_mask_difference_post ../../dataset/EPIC_DATA/mask_completion/$2/left --calculate_mask_difference_out ../../dataset/EPIC_DATA/mask_differences/$2/left && \
# python helper.py --calculate_mask_difference_pre ../../dataset/EPIC_DATA/xmem_masks/$2/object/right/ --calculate_mask_difference_post ../../dataset/EPIC_DATA/mask_completion/$2/right --calculate_mask_difference_out ../../dataset/EPIC_DATA/mask_differences/$2/right && \
# python helper.py --delete_empty_masks ../../dataset/EPIC_DATA/mask_differences/$2/left && \
# python helper.py --delete_empty_masks ../../dataset/EPIC_DATA/mask_differences/$2/right && \
# python helper.py --erode_masks_dir ../../dataset/EPIC_DATA/mask_differences/$2/left && \
# python helper.py --erode_masks_dir ../../dataset/EPIC_DATA/mask_differences/$2/right && \
# python helper.py --dilate_masks_dir ../../dataset/EPIC_DATA/mask_differences/$2/left && \
# python helper.py --dilate_masks_dir ../../dataset/EPIC_DATA/mask_differences/$2/right && \
# python helper.py --recolor_masks_white ../../dataset/EPIC_DATA/mask_differences/$2/left && \
# python helper.py --recolor_masks_white ../../dataset/EPIC_DATA/mask_differences/$2/right && \
...
python preprocess_for_mask_completion.py ../../dataset/EPIC_DATA/frames/$1/$2/ ../../dataset/EPIC_DATA/hand_inpainting/$2 ../../dataset/EPIC_DATA/seq_for_mask_completion/$2 && \
cd ../sam2 && \
echo "Starting Mask Completion" && \
python mask_completion.py --videos ../../dataset/EPIC_DATA/seq_for_mask_completion/$2 --masks-left ../../dataset/EPIC_DATA/xmem_masks/$2/object/left --masks-right ../../dataset/EPIC_DATA/xmem_masks/$2/object/right --out ../../dataset/EPIC_DATA/updated_mask_completion/$2 && \
cd ../scripts && \
echo "Calculating Mask Differences" && \
python helper.py --calculate_mask_difference_pre ../../dataset/EPIC_DATA/xmem_masks/$2/object/left/ --calculate_mask_difference_post ../../dataset/EPIC_DATA/updated_mask_completion/$2/left --calculate_mask_difference_out ../../dataset/EPIC_DATA/updated_mask_differences/$2/left && \
python helper.py --calculate_mask_difference_pre ../../dataset/EPIC_DATA/xmem_masks/$2/object/right/ --calculate_mask_difference_post ../../dataset/EPIC_DATA/updated_mask_completion/$2/right --calculate_mask_difference_out ../../dataset/EPIC_DATA/updated_mask_differences/$2/right && \
echo "Post Processing Mask Differences" && \
python determine_mask_overlap.py ../../dataset/EPIC_DATA/updated_mask_differences/$2/left ../../dataset/EPIC_DATA/xmem_masks/$2/hand/left && \
python determine_mask_overlap.py ../../dataset/EPIC_DATA/updated_mask_differences/$2/right ../../dataset/EPIC_DATA/xmem_masks/$2/hand/right && \
python helper.py --delete_empty_masks ../../dataset/EPIC_DATA/updated_mask_differences/$2/left && \ 
python helper.py --delete_empty_masks ../../dataset/EPIC_DATA/updated_mask_differences/$2/right && \
python helper.py --erode_masks_dir ../../dataset/EPIC_DATA/updated_mask_differences/$2/left && \
python helper.py --erode_masks_dir ../../dataset/EPIC_DATA/updated_mask_differences/$2/right && \
python helper.py --dilate_masks_dir ../../dataset/EPIC_DATA/updated_mask_differences/$2/left && \
python helper.py --dilate_masks_dir ../../dataset/EPIC_DATA/updated_mask_differences/$2/right && \
python helper.py --recolor_masks_white ../../dataset/EPIC_DATA/updated_mask_differences/$2/left && \
python helper.py --recolor_masks_white ../../dataset/EPIC_DATA/updated_mask_differences/$2/right && \
...
# Preprocess data for dataset
python modify_folder_to_sequence.py --dir ../../dataset/EPIC_DATA/xmem_masks/$2/hand/left --ref-folder ../../dataset/EPIC_DATA/bimanual_annotations_json/$2 --out ../../dataset/EPIC_DATA/sequences_bimanual/$2/left && \
python modify_folder_to_sequence.py --dir ../../dataset/EPIC_DATA/xmem_masks/$2/hand/right --ref-folder ../../dataset/EPIC_DATA/bimanual_annotations_json/$2 --out ../../dataset/EPIC_DATA/sequences_bimanual/$2/right && \
python helper.py --apply_padding_single_folder_dir ../../dataset/EPIC_DATA/xmem_masks/$2/object/left --apply_padding_single_folder_out ../../dataset/EPIC_DATA/padded_masks_unmodified_bimanual/$2/object/left && \
python helper.py --apply_padding_single_folder_dir ../../dataset/EPIC_DATA/xmem_masks/$2/object/right --apply_padding_single_folder_out ../../dataset/EPIC_DATA/padded_masks_unmodified_bimanual/$2/object/right && \

# Create dataset
python setup_dataset.py --video-id $2 --out ../../dataset/EPIC_DATA/$3/$2 --obj-name padded_masks_unmodified_bimanual --aff-name updated_mask_differences && \
...
rm -r ../../dataset/EPIC_DATA/updated_mask_completion/$2
rm -r ../../dataset/EPIC_DATA/xmem_masks_batched/$2
...
mkdir ../../dataset/Archived_Set/updated_mask_differences
...
tar -czvf ../../dataset/Archived_Set/updated_mask_differences/$2.tar.gz ../../dataset/EPIC_DATA/updated_mask_differences/$2 --remove-files
